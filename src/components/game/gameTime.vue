<template>
  <view class="group_4">
    <view class="text-group_4">
      ...
      <text lines="1" class="text_18">0608-9282</text>
    </view>
    <view class="text-wrapper_23">
      <text lines="1" class="text_19">235345|234|234|874|93</text>
      <text lines="1" class="text_20">0608-9282</text>
    </view>
    <image
  ...
  <!-- <view class="headerTime">
		<view class="headerTimeL">
			<view class="fontColor1 f24"> 00:23</view>
			<view class="f12"> 0023-9282</view>
		</view>
		<view class="headerTimeC">
			<view class="f33"> 27636776|4423|4423|4423</view>
