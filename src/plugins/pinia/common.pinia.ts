...
export const useCommon = defineStore("Common", {
  state() {
    return {
      ...
      TabDataTwo: [
        { label: "0", id: 0 ,checked: false},
        { label: "1", id: 1 ,checked: false},
        { label: "2", id: 2 ,checked: false},
        { label: "3", id: 3 ,checked: false},
        { label: "4", id: 4 ,checked: false},
        { label: "5", id: 5 ,checked: false},
        { label: "6", id: 6 ,checked: false},
        { label: "7", id: 7 ,checked: false},
        { label: "8", id: 8 ,checked: false},
        { label: "9", id: 9 ,checked: false},
      ],
      TabDataTwoStartEnd: [
