    ...
    actions: {
        setTabData(n: number) {
            ...
            if (n == 2) {
                ...
                this.TabDataTwoStartEnd[this.TabDataTwoCheckedID].checked = !this.TabDataTwoStartEnd[this.TabDataTwoCheckedID].checked
        ...
        setTabDataTwo1D2D3D(n: number) {
            ...
            if (n == 1) {
                this.TabDataTwoStartEnd2D[this.TabDataTwoCheckedID].checked = !this.TabDataTwoStartEnd2D[this.TabDataTwoCheckedID].checked
                this.TabDataTwo1D2D3D = this.TabDataTwoStartEnd2D
            }
            if (n == 2) {
                this.TabDataTwoStartEnd3D[this.TabDataTwoCheckedID].checked = !this.TabDataTwoStartEnd3D[this.TabDataTwoCheckedID].checked
        ...
        changeBoard(n:number){
            switch (n) {
                case 0:
                    this.TabDataAll=Array(10).fill(0).map((_,i)=>(
                        {label:String(i), id:i }))
                    break;
                case 1:
                    this.TabDataAll=Array(30).fill(0).map((_,i)=>(
                        {label:String(i), id:i }))
                    break;
                default :
                case 2:
