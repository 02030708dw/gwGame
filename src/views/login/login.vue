	...
	<view class="">
		<view class="bacAlipay">
			<view class="logo-style">
				<image src="../../static/images/bo/Group2200.png" mode=""></image>
			</view>
			...
			<u-form :model="form" ref="uForm">
				...
				<u-form-item :label-style="labelStyle">
					<view class="disrow">
						<u-input class="inputLogin" placeholder="请输入验证码" v-model="form.code" type="text" border="none"></u-input>
						<view class="" @click="getSmsCode('mobilelogin')">
							<button class="btnbtn" :class="codeBtn.codeStatus?'btn':'btn2'"
								:disabled="codeBtn.codeStatus" type="text" size="default">{{ codeBtn.codeText
          	  }}</button>
						</view>
					</view>
				</u-form-item>
		...
		<view class="fixbottom">
			...
			<view class="color1"> 《小小管家用户协议》《隐私政策》</view>
		</view>
	</view>
</template>
...
<script setup lang="ts">
	...
	const active2 = '../../static/images/bo/r2.png';
	const active1 = '../../static/images/bo/r1.png';
